...
// OSAdmin 常量
define('ADMIN_URL' ,'http://192.168.10.100/ssosch/ssosch_admin');//上线后更改为线上路径
define('ADMIN_TITLE' ,'管理后台');
define('COMPANY_NAME' ,'SSOSCH');//这里更改网站名称
...
// COOKIE 加密密钥，建议修改
// 默认 define('OSA_ENCRYPT_KEY','whatafuckingday!');
define('OSA_ENCRYPT_KEY','woshinilaolao!');
