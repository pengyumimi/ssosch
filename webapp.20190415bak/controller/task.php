...
if ($fsctype == '1') {
    $sql = "select * from web_formshengchan where uid = '{$uid}' and step1 = 1 or pid = '{$uid}' and step2 = 1";
...
//    print_r($jarr);//查看数组
    ...
    $sql = "select * from web_formshengchan where uid = '{$uid}' and step1 = 2 or pid = '{$uid}' and step2 = 2";
    $result = $mysqli->query($sql);
