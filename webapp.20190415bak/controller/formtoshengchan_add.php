...
if($fname == '')
	...
	else
	{
		...
		$sql = "insert into web_formshengchan(uid,fname,fphone,faddress,femail,ffsrc,fisrc,ftime,finfo,fradio,step1)values('{$uid}','{$fname}','{$fphone}','{$faddress}','{$femail}','{$ffsrc}','{$fisrc}','{$ftime}','{$finfo}','{$fradio}',1)";
